...
class MoveEvaluator {
    ...
    private Line direction1(Point p, Board board){
        Line line = new Line();
        line.addMine();
        spliceLine(p, board, line, true,  p0 -> new Point(p0.getX()-1 ,p0.getY()));
        spliceLine(p, board, line, false,  p0 -> new Point(p0.getX()+1 ,p0.getY()));
        return line;
    }
    ...
    private Line direction2(Point p, Board board){
        Line line = new Line();
        line.addMine();
        spliceLine(p, board, line, true,  p0 -> new Point(p0.getX()-1 ,p0.getY()-1));
        // TODO 死循环
        spliceLine(p, board, line, false,  p0 -> new Point(p0.getX()+1 ,p0.getY()+1));
        return line;
    }
    ...
    private Line direction3(Point p, Board board){
        Line line = new Line();
        line.addMine();
        spliceLine(p, board, line, true,  p0 -> new Point(p0.getX() ,p0.getY()-1));
        spliceLine(p, board, line, false,  p0 -> new Point(p0.getX() ,p0.getY()+1));
        return line;
    }
