...
class LineEvaluation {
    ...
    LineEvaluation(){
        ...
        // 约定0代表1个空位  1代表我方棋子
        lineScoreMap.put("01100",scores[0]);
        lineScoreMap.put("00110",scores[0]);
        // 离确保胜利还差两步
        lineScoreMap.put("11010",scores[1]);
        lineScoreMap.put("01011",scores[1]);
        ...
        lineScoreMap.put("001011",scores[1]);
        lineScoreMap.put("11100",scores[1]);
        lineScoreMap.put("01110",scores[1]);
        lineScoreMap.put("00111",scores[1]);
        //离确保胜利还差一步
        // 注意上文已经定义了边界条件是 >2个0  对手棋子 遇到边界，因此“活三”需要分情况讨论 而 x01110x实际上不属于“活三”
        lineScoreMap.put("011100",scores[2]);
        lineScoreMap.put("001110",scores[2]);
        lineScoreMap.put("010110",scores[2]);
        lineScoreMap.put("0010110",scores[2]);
        lineScoreMap.put("011010",scores[2]);
        lineScoreMap.put("0011010",scores[2]);
        lineScoreMap.put("01111",scores[2]);
        lineScoreMap.put("001111",scores[2]);
        lineScoreMap.put("10111",scores[2]);
        lineScoreMap.put("010111",scores[2]);
        lineScoreMap.put("0010111",scores[2]);
        lineScoreMap.put("11011",scores[2]);
        lineScoreMap.put("011011",scores[2]);
        lineScoreMap.put("0011011",scores[2]);
        lineScoreMap.put("11101",scores[2]);
        lineScoreMap.put("011101",scores[2]);
        lineScoreMap.put("0011101",scores[2]);
        lineScoreMap.put("11110",scores[2]);
        lineScoreMap.put("011110",scores[3]);
        lineScoreMap.put("0011110",scores[3]);
        lineScoreMap.put("11111",scores[3]);
        lineScoreMap.put("011111",scores[3]);
        lineScoreMap.put("0011111",scores[3]);
